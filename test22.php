		...
		<div class="row">
            	...
            	<!-- /.mail inbox col --> 
          		...
          		<!-- ================================== Previous & Next ======================================== -->
								...
								$messageid = $_GET["propertyid"];
								$updateMailBoxCount = "UPDATE contactus SET status='respond' WHERE id=$messageid";
															
								$getmail = "SELECT * FROM property WHERE propertyid=$messageid";
						...
						<div class="box box-primary">
							...
							<?php
								while ($row = mysqli_fetch_array($output)){
									...
									$contactEmail = $row["address1"];
									$contactMailName = $row["town"];
									$contactMobile = $row["county"];
									$mailContent = $row["price"];
									$emailCreated = $row["sale_or_rent"];
