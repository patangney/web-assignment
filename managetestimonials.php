...
-->
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="managetestimonials.php"><i class="fa fa-commenting-o"></i> <span>Manage Testimonials</span></a>
					</li>
					...
					<li class="treeview"> <a href="#"><i class="fa fa-home"></i> <span>Manage Properties</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
						<ul class="treeview-menu">
							...
							<li><a href="manage_residential.php">Manage Resi
        <!-- Optionally, you can add icons to the links -->
        <li class="active"><a href="admindashboard.php"><i class="fa fa-link"></i> <span>Dashboard</span></a>
							</li>
        ...
        <small>Control Panel</small>
			...
			<section class="content">
				...
				$getAllComments = mysqli_query( $link, "SELECT * FROM comment" );



				?>

				<div class="table-responsive manage_testimonials">
				<div class="system-message"><strong><?php echo $_SESSION['success_msg']?></strong></div>
					...
					<table class="table table-hover table-striped">
						<tbody>
							...
							<?php 
									...
									while($row = mysqli_fetch_array($getAllComments)){ 
										$id = $row["id"];
							...
							<tr>
								...
								<td><a href="manage_comments_approve.php?id=<?php echo $id; ?>"><i class="fa fa-thumbs-o-up fa-2x"></i></a> </td>
								<td><a href="manage_comments_denied.php?id=<?php echo $id; ?>"><i class="fa fa-thumbs-o-down fa-2x"></i></a>
								</td>
								<td>
									<a href="manage_comments_delete.php?id=<?php echo $id; ?>"><i class="fa fa-times fa-2x"></i></a>
								</td>
