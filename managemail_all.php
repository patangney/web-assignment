						...
						<div class="box box-solid">
							...
							<div class="box-body no-padding">
								<ul class="nav nav-pills nav-stacked">
									<li> <a href="managemail.php"><i class="fa fa-inbox"></i> New Mail <span class="label label-primary pull-right"><?php echo $countNewMail; ?></span></a>
									</li>
									<li class="active"><a href="managemail_all.php"><i class="fa fa-envelope-square"></i> All Mail<span class="label label-success pull-right"><?php echo $countAllMail; ?></span></a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="box-header with-border">
								...
								<div class="box-body no-padding">
									...
									<?php
										...
										$getAllMail = mysqli_query($link,"SELECT * FROM contactus");
