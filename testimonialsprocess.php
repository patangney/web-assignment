								...
								<nav id="primary-menu">
									<ul class="main-menu text-center">
										...
										<li><a href="#">Properties</a>
											<ul class="drop-menu">
												<li><a href="displayallproperties.php">All Properties</a>
												</li>
												<li><a href="displayproperties.php?categoryid=1">Residential</a>
												</li>
												<li><a href="displayproperties.php?categoryid=2">Commercial</a>
												</li>
												<li><a href="displayproperties.php?categoryid=3">Sites</a>
												</li>
											</ul>
										</li>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="breadcrumbs">
							<h2 class="breadcrumbs-title">Testimonaials</h2>
							<ul class="breadcrumbs-list">
								<li><a href="index.php">Home</a>
								</li>
								<li><a href="testimonials.php">Testimonaials</a>
								</li>
								<li>Message Sent</li>
							</ul>
						</div>
					...
					<div class="row">
						<div class="col-lg-12 sql-reply">
							...
							<?php
								...
								$sql_insert = "INSERT INTO comment(content, author_name, author_email, title)
								VALUES ('$content', '$author_name', '$author_email', '$title')";

							if ( mysqli_query( $link, $sql_insert ) ) {
								
								echo '
									<h2>Thank you for your review, a administrator will review your message!</h2>
								';
								...
								echo '
									...
									<h2>An error has occured, try again!</h2>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-5 hidden-sm col-xs-12">
							<div class="footer-widget middle">
								...
								<div class="social">
									<div class="facebook-icon mediaicons"><a href="http://www.facebook.com" target="_blank"></a>
									</div>
									<div class="linkedin-icon mediaicons"><a href="http://www.linkedin.com" target="_blank"></a>
									</div>
									<div class="pinterest-icon mediaicons"><a href="http://www.pintrest.com" target="_blank"></a>
									</div>
									<div class="instagram-icon mediaicons"><a href="http://www.pintrest.com" target="_blank"></a>
									</div>
									<div class="plus-icon mediaicons"><a href="http://www.plus.google.com" target="_blank"></a>
									</div>
								</div>
