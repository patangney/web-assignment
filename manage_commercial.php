...
-->
      ...
      <!-- Sidebar Menu -->
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="admindashboard.php"><i class="fa fa-drupal"></i> <span>Dashboard</span></a>
					</li>
		...
		<div class="box box-solid">
			...
			<div class="box-body no-padding">
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"> <a href="manage_commercial.php"><i class="fa fa-building"></i> Manage Commercial <span class="label label-default pull-right"><?php echo $countCom; ?></span></a>
					</li>
	...
	<!-- ./end manage properties information box -->
					...
					<table class="table table-hover table-striped">
						<tbody>
							...
							<?php 
								$getAllPropety = mysqli_query($link,"SELECT * FROM property WHERE categoryid=2");
						...
						<tr>
							...
							?>
							<td><a href="manageproperty-edit.php?id=<?php echo $row['propertyid'] ?>"><div class="btn btn-bitbucket">Edit</div></a></td>
