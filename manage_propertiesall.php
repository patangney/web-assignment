        ...
        <small>Control Panel</small>
			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-xs-6">
						<div class="small-box bg-green">
							...
							<a href="managemail_all.php" class="small-box-footer">Manage Enquiries <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					<!-- ./end enquiries -->
					<!-- Enquiries  -->
					<div class="col-lg-3 col-xs-6">
						<div class="small-box bg-yellow">
							...
							<a href="managenewsletters.php" class="small-box-footer">Manage Newsletters <i class="fa fa-arrow-circle-right"></i></a>
						</div>
						<!-- ./end enquiries -->
					</div>
					<!-- ./Information row -->
					...
					<div class="box box-solid">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li> <a href="manage_residential.php"><i class="fa fa-home"></i> Manage Residential <span class="label label-info pull-right"><?php echo $countRes; ?></span></a>
								</li>
								...
								<li class="active"><a href="managemail_all.php"><i class="fa fa-list"></i> All Properties<span class="label label-danger pull-right"><?php echo $countAll; ?></span></a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="table-responsive manage_property">
					...
					<table id="allproperties " class="table table-hover table-striped">
						<tbody>
							<thead>
								<tr>
							...
							<?php 
								$getAllPropety = mysqli_query($link,"SELECT * FROM property");
							...
							<tr>
								<td align="center"><input type="checkbox" name="propertyid[]" class="checkbox" value="<?php echo $row['propertyid']; ?>"/>
								</td>
								<td><img style="max-height: 100px; max-width: 100px;" src="images/forsale/<?php echo $row['image_folder']; ?>/<?php echo $row['image_thumbs']; ?>" </td>
									...
									<td>
										<a href="manageproperty-edit.php?propertyid=<?php echo $row['propertyid'] ?>">
											<div class="btn btn-bitbucket">Edit</div>
										</a>
									</td>
									<td><a href=""></a>
									</td>
