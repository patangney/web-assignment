...
<div class="wrapper"> 
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="breadcrumbs">
            <h2 class="breadcrumbs-title">Testimonials</h2>
  ...
  <div id="page-content" class="page-wrapper"> 
    ...
    <!-- ELEMENTS AREA START -->
    <div class="elements-area pt-115"> 
              ...
              <div class="testimonial">
                <div class="row">
						...
						mysqli_select_db( $link, "property" );
					  	...
					  	while($row = mysqli_fetch_array($result)){
							...
							echo '
									 ...
									 <div class="client-testimonials testi-background mt-10 mb-30"> 
									  <!-- testimonial-item -->
									  <div class="testimonial-item mt-20 mb-30">
										<div class="testimonial-brief">
											<h5>'.$title.'</h5>
											  <p>'.$content.'</p>
										</div>
										<h6>'.$author.', <span>CEO</span></h6>
									  </div>
									</div>
                  ...
                  <div class="col-md-4 col-sm-3">
                    <div class="testimonial-image"> <img src="images/others/client.png" alt="Happy Clients"> </div>
                  </div>
                </div>
              </div>
            </div>
