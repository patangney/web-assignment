...
<head>
	...
	<!-- iCheck-->
	<link rel="stylesheet" href="admin/plugins/iCheck/flat/purple.css">
					...
					<div class="col-lg-3 col-xs-6">
						<div class="small-box bg-aqua">
							<div class="inner">
								<div class="row">
									<div class="col-lg-12">
										<p><strong>Total Properties Online: <?php echo $countAll; ?></strong>
										</p>
									</div>
									<div class="col-lg-4">
										<h3>
							...
							<a href="manage_propertiesall.php" class="small-box-footer">Manage Properties <i class="fa fa-arrow-circle-right"></i></a> </div>
					</div>
					<!-- ./col -->
							...
							<div class="inner">
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<p>Comments Pending </p>
									</div>
								</div>
							</div>
							<div class="icon"> <i class="ion ion-chatboxes"></i> </div>
							<a href="managetestimonials.php" class="small-box-footer">Manage Testimonials <i class="fa fa-arrow-circle-right"></i></a> </div>
					</div>
					<!-- ./end Testimonials -->
					<!-- Enquiries  -->
					<div class="col-lg-3 col-xs-6">
						<div class="small-box bg-green">
							...
							<a href="managemail.php" class="small-box-footer">Manage Enquiries <i class="fa fa-arrow-circle-right"></i></a> </div>
					</div>
					<!-- ./end enquiries -->
					<!-- Enquiries  -->
					<div class="col-lg-3 col-xs-6">
						<div class="small-box bg-yellow">
							...
							<a href="manage_newsletters.php" class="small-box-footer">Manage Newsletters <i class="fa fa-arrow-circle-right"></i></a> </div>
					</div>
					<!-- ./end enquiries -->
						...
						<div class="box box-solid">
							...
							<div class="box-body no-padding">
								<ul class="nav nav-pills nav-stacked">
									<li class="active"> <a href="managemail.php"><i class="fa fa-inbox"></i> New Mail <span class="label label-primary pull-right"><?php echo $countNewMail; ?></span></a>
									</li>
									<li><a href="managemail_all.php"><i class="fa fa-envelope-square"></i> All Mail<span class="label label-success pull-right"><?php echo $countAllMail; ?></span></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-md-9">
						<div class="box box-primary">
							<div class="box-header with-border">
								...
								<!-- get enquires from database -->
								<div class="box-body no-padding">

									<!-- mail recieved -->
									<?php
									
										$getMailID = mysqli_query($link,"SELECT * FROM contactus");
									
										while($row2=mysqli_fetch_array($getMailID)){
											$returnID = $row2["id"];
										}
									...
									<?php
										...
										$getAllMail = mysqli_query($link,"SELECT * FROM contactus WHERE status='new_email'");
									...
									<div class="table-responsive mailbox-messages">
										...
										<table class="table table-hover table-striped">
											<tbody>
												...
												<?php 
													if(mysqli_num_rows($getAllMail)>0){
														while($row = mysqli_fetch_assoc($getAllMail)){ 

										        ?>
										        
											<tr>
												<td align="center"><input type="checkbox" name="id[]" class="checkbox" value="<?php echo $row['id']; ?>"/></td>        
												<td><a href="managemail-open.php?id=<?php echo $row['id'] ?>"</a><?php echo $row['contact_name']?></td>
												<td>0<?php echo $row['contact_mobile']; ?></td>
											...
											<?php 
												...
												?>
													<tr><td colspan="5">You have no new mail.</td></tr> 
											<?php 
												} 
											?>
										</table>
										<div class="delete-btn"><input type="submit" name="bulk_delete_submit" value="Delete" class="btn btn-danger"/></div>
